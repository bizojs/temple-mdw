        ...
        <form method="POST" action="?/createCharacter" class="flex flex-col gap-6" use:enhance>
            <div class="flex flex-col gap-2">
                ...
                <input
                    ...
                    name="fullname" 
                    type="text"
                    class="p-2 rounded-lg bg-neutral-800 text-white focus:bg-neutral-800"
                    autocomplete="off"
                    required
                >
            </div>
            ...
            <div class="flex gap-2 items-center text-gray-300">
                ...
                <button on:click|preventDefault={cancel} class="border-2 border-gray-300 px-3 py-2 rounded-md hover:bg-nav-btn transition-all">
                    Cancel
                </button>
            </div>
        </form>
